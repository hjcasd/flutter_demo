...
class ChannelHelper {
  // EventChannel
  static const EventChannel _eventChannel = EventChannel('com.flutter/event');

  // MethodChannel
  static const MethodChannel _methodChannel = MethodChannel('com.flutter/method');
  ...
  /// 使用EventChannel与原生交互
  static void receiveStream(void Function(dynamic)? onData) {
    _eventChannel.receiveBroadcastStream('event').listen(onData);
  }
