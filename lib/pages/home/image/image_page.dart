...
import 'package:flutter_demo/components/image/simple_image.dart';
...
class MyLocalImage extends StatelessWidget {
  const MyLocalImage({Key? key}) : super(key: key);
...
class MyNetImage extends StatelessWidget {
  const MyNetImage({Key? key}) : super(key: key);
...
class MyCircleBoxImage extends StatelessWidget {
  const MyCircleBoxImage({Key? key}) : super(key: key);
...
class MyCircleClipImage extends StatelessWidget {
  const MyCircleClipImage({Key? key}) : super(key: key);
